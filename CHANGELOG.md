...
* **azerty:** add ryzen 5000 series  ([#878](https://github.com/hifihedgehog/3dprintingpeddler/issues/878)) ([ca59777](https://github.com/hifihedgehog/3dprintingpeddler/commit/ca59777917777401affc5b72a68238983f286237))
...
* **notification:** add Streamlabs support ([#1872](https://github.com/hifihedgehog/3dprintingpeddler/issues/1872)) ([edb39f8](https://github.com/hifihedgehog/3dprintingpeddler/commit/edb39f8f05451c3cc1994c0beb2338bae04ab585))
...
* **store:** add darkhero motherboard to asus and microcenter ([#1336](https://github.com/hifihedgehog/3dprintingpeddler/issues/1336)) ([29175c7](https://github.com/hifihedgehog/3dprintingpeddler/commit/29175c77a8fcbc082c944b057a919dfcc22ba606))
...
* **store:** addition of several australian sites ([#1651](https://github.com/hifihedgehog/3dprintingpeddler/issues/1651)) ([2fa8937](https://github.com/hifihedgehog/3dprintingpeddler/commit/2fa893795f21535e1799116843e0668b669835ab))
...
* **amazon-ca:** update selector ([#1851](https://github.com/hifihedgehog/3dprintingpeddler/issues/1851)) ([3293184](https://github.com/hifihedgehog/3dprintingpeddler/commit/329318427fc3eb1081751289401269119a252905))
...
* **discord:** properly wait for webhooks ([#2352](https://github.com/hifihedgehog/3dprintingpeddler/issues/2352)) ([bc59da1](https://github.com/hifihedgehog/3dprintingpeddler/commit/bc59da11d512f6f55449781cb8f7f4bd1d3e7e57))
...
* parsing prices with thousands separator and European format ([#2153](https://github.com/hifihedgehog/3dprintingpeddler/issues/2153)) ([61f8e3a](https://github.com/hifihedgehog/3dprintingpeddler/commit/61f8e3a9a03136682035881fce6d14356717d1ac))
...
* **wipoid:** added 3090/3080/3070/3060ti/ryzen store items ([#1683](https://github.com/hifihedgehog/3dprintingpeddler/issues/1683)) ([be54171](https://github.com/hifihedgehog/3dprintingpeddler/commit/be541713a8855f18b5102917751842e514796e00))
...
* fix nightly release ([5f81a8a](https://github.com/hifihedgehog/3dprintingpeddler/commit/5f81a8a25f60788d1c529078aab89675d6b5ffc3))
...
* remove twitter ([d19d05c](https://github.com/hifihedgehog/3dprintingpeddler/commit/d19d05c2e5d4e6e20085116177e4320f74ddfe54))
...
* add APNS to dotenv-example ([#2174](https://github.com/hifihedgehog/3dprintingpeddler/issues/2174)) ([4bd048f](https://github.com/hifihedgehog/3dprintingpeddler/commit/4bd048ff7a496e82e66293a9706581b8d10af6b3))
...
* bump node 16.5.0 ([4e3eade](https://github.com/hifihedgehog/3dprintingpeddler/commit/4e3eadea083071eba563dffc70d749db334dce69))
...
* **deps-dev:** bump @types/node from 15.3.0 to 15.6.1 ([#2571](https://github.com/hifihedgehog/3dprintingpeddler/issues/2571)) ([3e74a4c](https://github.com/hifihedgehog/3dprintingpeddler/commit/3e74a4c7c41c939b9ce0952e089f36269f3fb46f))
...
* **deps-dev:** bump webpack from 5.22.0 to 5.23.0 ([#1993](https://github.com/hifihedgehog/3dprintingpeddler/issues/1993)) ([b6030b3](https://github.com/hifihedgehog/3dprintingpeddler/commit/b6030b3cc3bdd4011b4bd5eba1789ce4224e8896))
...
* **deps:** bump cheerio from 1.0.0-rc.3 to 1.0.0-rc.5 ([#1495](https://github.com/hifihedgehog/3dprintingpeddler/issues/1495)) ([a402c64](https://github.com/hifihedgehog/3dprintingpeddler/commit/a402c64f5e82cc6a6a66a1197eaaaa0761063b22))
...
* **deps:** bump node-notifier from 9.0.1 to 10.0.0 ([#2583](https://github.com/hifihedgehog/3dprintingpeddler/issues/2583)) ([a751cb1](https://github.com/hifihedgehog/3dprintingpeddler/commit/a751cb11c53c7cf6b7883e69eb5e8e2fe1e57adf))
* **deps:** bump nodemailer from 6.6.0 to 6.6.1 ([#2568](https://github.com/hifihedgehog/3dprintingpeddler/issues/2568)) ([2e5b07c](https://github.com/hifihedgehog/3dprintingpeddler/commit/2e5b07c93fb02677596eb5a2f2ea857b99c2d4d9))
* **deps:** bump open from 7.3.0 to 7.3.1 ([#1630](https://github.com/hifihedgehog/3dprintingpeddler/issues/1630)) ([30f3fab](https://github.com/hifihedgehog/3dprintingpeddler/commit/30f3fab419fa913f75ae9b4317cef59aa6c916e5))
* **deps:** bump open from 7.3.1 to 7.4.0 ([#1856](https://github.com/hifihedgehog/3dprintingpeddler/issues/1856)) ([127d846](https://github.com/hifihedgehog/3dprintingpeddler/commit/127d846fbe0a100cd62242d17dca50982ad862d8))
* **deps:** bump open from 7.4.2 to 8.0.2 ([#2078](https://github.com/hifihedgehog/3dprintingpeddler/issues/2078)) ([00e4ddc](https://github.com/hifihedgehog/3dprintingpeddler/commit/00e4ddce162877a4a08747955859508f5af0a802))
* **deps:** bump open from 8.0.2 to 8.0.3 ([#2186](https://github.com/hifihedgehog/3dprintingpeddler/issues/2186)) ([54883f0](https://github.com/hifihedgehog/3dprintingpeddler/commit/54883f0ad7cf86052035d88ed2ffbc612c439725))
* **deps:** bump open from 8.0.2 to 8.2.0 ([#2572](https://github.com/hifihedgehog/3dprintingpeddler/issues/2572)) ([36e188f](https://github.com/hifihedgehog/3dprintingpeddler/commit/36e188fd36d31a915d9ac59016710b6f3fa4436d))
* **deps:** bump puppeteer-extra from 3.1.15 to 3.1.16 ([#1678](https://github.com/hifihedgehog/3dprintingpeddler/issues/1678)) ([50ee40a](https://github.com/hifihedgehog/3dprintingpeddler/commit/50ee40a2d46965604eece2e53d2bc4da2a5b5c9d))
* **deps:** bump puppeteer-extra-plugin-adblocker from 2.11.9 to 2.11.10 ([#1681](https://github.com/hifihedgehog/3dprintingpeddler/issues/1681)) ([58761fc](https://github.com/hifihedgehog/3dprintingpeddler/commit/58761fc48e0e6d7cb4fa4e91e68500922bcd1277))
* **deps:** bump puppeteer-extra-plugin-block-resources from 2.2.7 to 2.2.8 ([#1691](https://github.com/hifihedgehog/3dprintingpeddler/issues/1691)) ([9d7f908](https://github.com/hifihedgehog/3dprintingpeddler/commit/9d7f908e04266908510a3154e7b970958daa764d))
* **deps:** bump puppeteer-extra-plugin-stealth from 2.6.5 to 2.6.6 ([#1680](https://github.com/hifihedgehog/3dprintingpeddler/issues/1680)) ([513f578](https://github.com/hifihedgehog/3dprintingpeddler/commit/513f578fdc149577300d534bdf21a6d39e31dfd1))
* **deps:** bump puppeteer-extra-plugin-stealth from 2.6.6 to 2.6.7 ([#1794](https://github.com/hifihedgehog/3dprintingpeddler/issues/1794)) ([3b204f1](https://github.com/hifihedgehog/3dprintingpeddler/commit/3b204f15ac6e6a4c2d72e8a83474baf2db381665))
* **deps:** bump puppeteer-extra-plugin-stealth from 2.6.7 to 2.7.4 ([#1878](https://github.com/hifihedgehog/3dprintingpeddler/issues/1878)) ([0cc4e4c](https://github.com/hifihedgehog/3dprintingpeddler/commit/0cc4e4c4b2afedda0828d87710c2f2f6c262b4eb))
* **deps:** bump top-user-agents from 1.0.25 to 1.0.26 ([#2556](https://github.com/hifihedgehog/3dprintingpeddler/issues/2556)) ([729afd0](https://github.com/hifihedgehog/3dprintingpeddler/commit/729afd0ef3f4ceea1ae38b04e1a25bc4c4dcd3ec))
* **deps:** bump twilio from 3.53.0 to 3.54.0 ([#1287](https://github.com/hifihedgehog/3dprintingpeddler/issues/1287)) ([7bfcc81](https://github.com/hifihedgehog/3dprintingpeddler/commit/7bfcc81fdcd788434d853f511d0697878b551e28))
* **deps:** bump twilio from 3.54.0 to 3.54.1 ([#1440](https://github.com/hifihedgehog/3dprintingpeddler/issues/1440)) ([8836a1c](https://github.com/hifihedgehog/3dprintingpeddler/commit/8836a1c1c45626a5790ea94688ef619f40ba5ec3))
* **deps:** bump twilio from 3.54.1 to 3.54.2 ([#1622](https://github.com/hifihedgehog/3dprintingpeddler/issues/1622)) ([1ed8eca](https://github.com/hifihedgehog/3dprintingpeddler/commit/1ed8eca6f9a3430cb86aa4ba02dddea525d0dfe8))
* **deps:** bump twilio from 3.54.2 to 3.55.0 ([#1679](https://github.com/hifihedgehog/3dprintingpeddler/issues/1679)) ([a6a69e7](https://github.com/hifihedgehog/3dprintingpeddler/commit/a6a69e7ae520ba6c7b09117adb9c4467b4ab7038))
* **deps:** bump twilio from 3.55.0 to 3.55.1 ([#1824](https://github.com/hifihedgehog/3dprintingpeddler/issues/1824)) ([4fe0f50](https://github.com/hifihedgehog/3dprintingpeddler/commit/4fe0f50941778aca92c0fbdc861506ca4c170b42))
* **deps:** bump twilio from 3.62.0 to 3.63.0 ([#2561](https://github.com/hifihedgehog/3dprintingpeddler/issues/2561)) ([7d35c2b](https://github.com/hifihedgehog/3dprintingpeddler/commit/7d35c2b8f0620501061220baefeb499d6e66e2da))
* **deps:** bump twilio from 3.66.1 to 3.71.1 ([#2837](https://github.com/hifihedgehog/3dprintingpeddler/issues/2837)) ([72140be](https://github.com/hifihedgehog/3dprintingpeddler/commit/72140bebdb7587c071398e0e3abd41bbb8caa10d))
* **deps:** bump twitch from 4.3.6 to 4.3.8 ([#1533](https://github.com/hifihedgehog/3dprintingpeddler/issues/1533)) ([13d4ee6](https://github.com/hifihedgehog/3dprintingpeddler/commit/13d4ee6a712db2945cda51c9e0eacec5f21086e4))
* **deps:** bump twitch from 4.4.0 to 4.4.5 ([#1783](https://github.com/hifihedgehog/3dprintingpeddler/issues/1783)) ([ba6eccc](https://github.com/hifihedgehog/3dprintingpeddler/commit/ba6eccc90a2c177a9dbbeeefe44a20e738b74475))
* **deps:** bump twitch from 4.4.5 to 4.4.6 ([#1831](https://github.com/hifihedgehog/3dprintingpeddler/issues/1831)) ([bb8c89b](https://github.com/hifihedgehog/3dprintingpeddler/commit/bb8c89b77566f9fa637fc136f3a255c0bcf23592))
* **deps:** bump twitch from 4.4.6 to 4.4.7 ([#1858](https://github.com/hifihedgehog/3dprintingpeddler/issues/1858)) ([b6d0331](https://github.com/hifihedgehog/3dprintingpeddler/commit/b6d03317bae978b7f84b865c651c6b7269ed9337))
* **deps:** bump twitch-auth from 4.3.6 to 4.3.8 ([#1532](https://github.com/hifihedgehog/3dprintingpeddler/issues/1532)) ([de69f7a](https://github.com/hifihedgehog/3dprintingpeddler/commit/de69f7ae8a20b7dbfd800e978fd5e45e569ed42f))
* **deps:** bump twitch-auth from 4.4.0 to 4.4.5 ([#1782](https://github.com/hifihedgehog/3dprintingpeddler/issues/1782)) ([a10ae42](https://github.com/hifihedgehog/3dprintingpeddler/commit/a10ae4245495ede2436a6e76d7f27321cfe8bdef))
* **deps:** bump twitch-auth from 4.4.5 to 4.4.7 ([#1855](https://github.com/hifihedgehog/3dprintingpeddler/issues/1855)) ([233c449](https://github.com/hifihedgehog/3dprintingpeddler/commit/233c4496e2e763498c414130d00285feebf958a7))
* **deps:** bump twitch-chat-client from 4.3.5 to 4.3.6 ([#1308](https://github.com/hifihedgehog/3dprintingpeddler/issues/1308)) ([37962f0](https://github.com/hifihedgehog/3dprintingpeddler/commit/37962f00e5a88f5f185b79c34902d6cf4ecec936))
* **deps:** bump twitch-chat-client from 4.3.6 to 4.3.8 ([#1534](https://github.com/hifihedgehog/3dprintingpeddler/issues/1534)) ([a74980b](https://github.com/hifihedgehog/3dprintingpeddler/commit/a74980b728c3f44c35f5c4423fd0d9af777422f8))
* **deps:** bump twitch-chat-client from 4.4.0 to 4.4.5 ([#1784](https://github.com/hifihedgehog/3dprintingpeddler/issues/1784)) ([8c38323](https://github.com/hifihedgehog/3dprintingpeddler/commit/8c383235af265758b5a1fed2868113b42d7d3fad))
* **deps:** bump twitch-chat-client from 4.4.13 to 4.5.1 ([#2127](https://github.com/hifihedgehog/3dprintingpeddler/issues/2127)) ([eeab4b1](https://github.com/hifihedgehog/3dprintingpeddler/commit/eeab4b112a6482d4fd381014e44fd0d6e071c494))
* **deps:** bump twitch, notifier, mailer, typescript, node, and webpack ([64898b8](https://github.com/hifihedgehog/3dprintingpeddler/commit/64898b8ae355b0112ee507630ec3224b71f1eff9))
* **deps:** bump url-parse from 1.5.3 to 1.5.10 ([#2964](https://github.com/hifihedgehog/3dprintingpeddler/issues/2964)) ([6f57777](https://github.com/hifihedgehog/3dprintingpeddler/commit/6f57777c603f8f4535b0d3d72087a20a1d8ea740))
* **docker:** remove erroneous extra copy ([9225582](https://github.com/hifihedgehog/3dprintingpeddler/commit/922558262b664da1e8f7a69a156582345f35a291))
* **elkjop:** update selectors ([#2505](https://github.com/hifihedgehog/3dprintingpeddler/issues/2505)) ([c9049a3](https://github.com/hifihedgehog/3dprintingpeddler/commit/c9049a3054d35f8a37340e552e19841e3ecaf631))
* **evga:** add 3060ti cards ([14998d8](https://github.com/hifihedgehog/3dprintingpeddler/commit/14998d87f99acf171ace85e1eb9b059d9e0a5b65))
* **evga:** add 3080 hydro copper ([578027a](https://github.com/hifihedgehog/3dprintingpeddler/commit/578027a36b25f1d1da2fd305ce1454561a33e091)), closes [#965](https://github.com/hifihedgehog/3dprintingpeddler/issues/965)
* fix issue template config ([1538937](https://github.com/hifihedgehog/3dprintingpeddler/commit/1538937661dbce7d28f63c1cc75ec8cdf91754f0))
* **galaxus:** update selector ([#1693](https://github.com/hifihedgehog/3dprintingpeddler/issues/1693)) ([bc45fd8](https://github.com/hifihedgehog/3dprintingpeddler/commit/bc45fd8d119bcee21d995abc373a154b92377edc))
* **gamestop:** update inventory ([#2239](https://github.com/hifihedgehog/3dprintingpeddler/issues/2239)) ([c1c92bd](https://github.com/hifihedgehog/3dprintingpeddler/commit/c1c92bd25b7b744a05f21664f2029a0cb0683d35))
* **globaldata:** add 3060, 3060ti, amd ([#2044](https://github.com/hifihedgehog/3dprintingpeddler/issues/2044)) ([11e1465](https://github.com/hifihedgehog/3dprintingpeddler/commit/11e14655e1c7a8022bebea2f76cc94ba903b29d8))
* ignore docs and add web to Dockerfile ([95f112c](https://github.com/hifihedgehog/3dprintingpeddler/commit/95f112c500168b389db5da5544f2d105518835ce))
* improve linksBuilder logging ([#2785](https://github.com/hifihedgehog/3dprintingpeddler/issues/2785)) ([73eaa88](https://github.com/hifihedgehog/3dprintingpeddler/commit/73eaa88fa1ed7ef47a333fbe91875c460d00dd6e))
* **ldlc:** add 3050 ([#2948](https://github.com/hifihedgehog/3dprintingpeddler/issues/2948)) ([a146ea3](https://github.com/hifihedgehog/3dprintingpeddler/commit/a146ea351db46e21553990f625a90dbdbd72f395))
* **lint:** add void for dangling promise ([52c7e74](https://github.com/hifihedgehog/3dprintingpeddler/commit/52c7e743724883edf2e49fea7984d185c23ec3ac))
* **main:** release 3.6.0 ([#3062](https://github.com/hifihedgehog/3dprintingpeddler/issues/3062)) ([dbc6691](https://github.com/hifihedgehog/3dprintingpeddler/commit/dbc669177ed238f659a5e540b1ae973fa47701b8))
* **main:** release 3.7.0 ([#3063](https://github.com/hifihedgehog/3dprintingpeddler/issues/3063)) ([d59b98e](https://github.com/hifihedgehog/3dprintingpeddler/commit/d59b98ecef6f600aec6d1eccbd642a90ee0ff943))
* **main:** release 3.7.1 ([#3064](https://github.com/hifihedgehog/3dprintingpeddler/issues/3064)) ([392e0bb](https://github.com/hifihedgehog/3dprintingpeddler/commit/392e0bb239fc4ff15ba3838f3c34a43b7b24b257))
* **main:** release 3.8.0 ([#3072](https://github.com/hifihedgehog/3dprintingpeddler/issues/3072)) ([dbcc83b](https://github.com/hifihedgehog/3dprintingpeddler/commit/dbcc83b2ab7ee124abf08729e337fc714fa72fad))
* **main:** release 3.8.1 ([#3089](https://github.com/hifihedgehog/3dprintingpeddler/issues/3089)) ([cd89878](https://github.com/hifihedgehog/3dprintingpeddler/commit/cd8987892873f44a5fab1ed24ff6372c6ed842cf))
* **main:** release 3.8.2 ([#3090](https://github.com/hifihedgehog/3dprintingpeddler/issues/3090)) ([21c95ad](https://github.com/hifihedgehog/3dprintingpeddler/commit/21c95ad947628bcc0fc65bd0ccc47a7ecfbbf9cc))
* **main:** release 3.8.3 ([#3091](https://github.com/hifihedgehog/3dprintingpeddler/issues/3091)) ([ed59c19](https://github.com/hifihedgehog/3dprintingpeddler/commit/ed59c193942a3c2ef415ec23011bdec17652b071))
* **materiel:** add 3070 and 3080 cards ([#2393](https://github.com/hifihedgehog/3dprintingpeddler/issues/2393)) ([8c39d0d](https://github.com/hifihedgehog/3dprintingpeddler/commit/8c39d0d30a9f8db7eda8665eb08d350fadf157e4))
* **mediamarkt, saturn:** add new outOfStock message ([#2850](https://github.com/hifihedgehog/3dprintingpeddler/issues/2850)) ([5d4f4c5](https://github.com/hifihedgehog/3dprintingpeddler/commit/5d4f4c5b82f13f8f0e6ef288a77aaf85acbafcb8))
* **mediamarkt:** update captcha selector ([#2496](https://github.com/hifihedgehog/3dprintingpeddler/issues/2496)) ([64120e7](https://github.com/hifihedgehog/3dprintingpeddler/commit/64120e73d8f3a01dd5852044ffa0ef6b0ce31730))
* **microcenter:** add 3090 cards ([d46c636](https://github.com/hifihedgehog/3dprintingpeddler/commit/d46c6366b70ca668437bd2aab87c3c529f4c569b))
* move linksBuilder log, add outOfStock amd-de ([9dc04b3](https://github.com/hifihedgehog/3dprintingpeddler/commit/9dc04b36388907f07da5555d19fa517ed0b207ed))
* move lookup loop logging to lower level ([#2784](https://github.com/hifihedgehog/3dprintingpeddler/issues/2784)) ([a20faaa](https://github.com/hifihedgehog/3dprintingpeddler/commit/a20faaab78ca5bf82240c10a944d55d806af7ffc))
* **multicom:** update selectors ([#2499](https://github.com/hifihedgehog/3dprintingpeddler/issues/2499)) ([7c4c6ed](https://github.com/hifihedgehog/3dprintingpeddler/commit/7c4c6ed79ecd89767ffbb3577716be28ce6c1bdc))
* **netonnet-no:** update selectors ([#2547](https://github.com/hifihedgehog/3dprintingpeddler/issues/2547)) ([0378a7c](https://github.com/hifihedgehog/3dprintingpeddler/commit/0378a7cf0aa673933af35c3a3605f147615f6e96))
* **newegg-sg:** add missing 3060ti, 3070, 3080, 3090 cards ([#1742](https://github.com/hifihedgehog/3dprintingpeddler/issues/1742)) ([aec8cfd](https://github.com/hifihedgehog/3dprintingpeddler/commit/aec8cfdae2121974c75bffc9130d43c06de5b32a))
* **newegg:** add 3060 links ([#2039](https://github.com/hifihedgehog/3dprintingpeddler/issues/2039)) ([6934d5b](https://github.com/hifihedgehog/3dprintingpeddler/commit/6934d5b31cb293f2e833b6c90eeaa7b0755704aa))
* **newegg:** add links for rx6800xt and rx6800 ([#1484](https://github.com/hifihedgehog/3dprintingpeddler/issues/1484)) ([5a6b252](https://github.com/hifihedgehog/3dprintingpeddler/commit/5a6b252ae1923bd8d4277434576d60cc8827d0b6))
* **newegg:** add missing 3060ti, 3070, 3080, 3090 cards ([#1741](https://github.com/hifihedgehog/3dprintingpeddler/issues/1741)) ([9bf0e30](https://github.com/hifihedgehog/3dprintingpeddler/commit/9bf0e302229b1f7a220d1978c7b6e8cc18fbf426))
* **neweggca:** add missing 3060ti, 3070, 3080, 3090 cards ([#1743](https://github.com/hifihedgehog/3dprintingpeddler/issues/1743)) ([13f1c3d](https://github.com/hifihedgehog/3dprintingpeddler/commit/13f1c3d50ca7c201729b67df22f8195fb42e7318))
* **nodejs:** bump version ([#2088](https://github.com/hifihedgehog/3dprintingpeddler/issues/2088)) ([afe7a70](https://github.com/hifihedgehog/3dprintingpeddler/commit/afe7a709009f43fba1cef22aa6c136976507c7bc))
* **notification:** add better logging, remove debug ([d12639e](https://github.com/hifihedgehog/3dprintingpeddler/commit/d12639ee8561240d99ef5c2c364255ff808f78b0))
* **nvidia:** add 3070ti & 3080ti ([#2798](https://github.com/hifihedgehog/3dprintingpeddler/issues/2798)) ([ada90bf](https://github.com/hifihedgehog/3dprintingpeddler/commit/ada90bf6de4311256a6928bff3f382e4c2142f32))
* **officedepot:** add 3070 ([#1280](https://github.com/hifihedgehog/3dprintingpeddler/issues/1280)) ([54ef0ef](https://github.com/hifihedgehog/3dprintingpeddler/commit/54ef0ef9950babd86d1fb0e2a1cc91030fbdb068))
* **otto:** add labels for xbox series x & s ([#2515](https://github.com/hifihedgehog/3dprintingpeddler/issues/2515)) ([d0a6c7e](https://github.com/hifihedgehog/3dprintingpeddler/commit/d0a6c7e85950fe3cffbcb30662967a687aaf7347))
* **pccomponentes:** add 3090, 3060ti, rx6900xt ([#1962](https://github.com/hifihedgehog/3dprintingpeddler/issues/1962)) ([b1ece9e](https://github.com/hifihedgehog/3dprintingpeddler/commit/b1ece9edad6d11d6241bf97ebd764dc902ed788b))
* **pcdiga:** add 3090, 3070, 3060ti ([#2003](https://github.com/hifihedgehog/3dprintingpeddler/issues/2003)) ([d422c7d](https://github.com/hifihedgehog/3dprintingpeddler/commit/d422c7d0d3193da60e05f668178f9c8da87a2466))
* **philips-hue:** correct the log text ([#1523](https://github.com/hifihedgehog/3dprintingpeddler/issues/1523)) ([ca1564e](https://github.com/hifihedgehog/3dprintingpeddler/commit/ca1564e8faa9fb62763a5f2fdc7993a1db238413))
* **proshop-dk:** add 3060ti, add 3070, update 3080, update 3090, add ryzen cpus ([#1526](https://github.com/hifihedgehog/3dprintingpeddler/issues/1526)) ([8e5c28e](https://github.com/hifihedgehog/3dprintingpeddler/commit/8e5c28e10bf98cbe6855d58d54e155e9ee07f6fa))
* prune invalid links ([#2592](https://github.com/hifihedgehog/3dprintingpeddler/issues/2592)) ([b33f678](https://github.com/hifihedgehog/3dprintingpeddler/commit/b33f678090396b77a5765115d7a3fa42f6de06c8))
* **redis:** init client once ([a908ce4](https://github.com/hifihedgehog/3dprintingpeddler/commit/a908ce417bf10d497c1f9531f2187f4379606432))
* release 3.3.0 ([#1233](https://github.com/hifihedgehog/3dprintingpeddler/issues/1233)) ([b97d581](https://github.com/hifihedgehog/3dprintingpeddler/commit/b97d58160792b80cf07ee2358e1532bdacf2a683))
* release 3.4.0 ([#1391](https://github.com/hifihedgehog/3dprintingpeddler/issues/1391)) ([f474cc6](https://github.com/hifihedgehog/3dprintingpeddler/commit/f474cc69664396fbde9bfd88aba4ad977f872e07))
* release 3.4.0 ([#1719](https://github.com/hifihedgehog/3dprintingpeddler/issues/1719)) ([b7930b2](https://github.com/hifihedgehog/3dprintingpeddler/commit/b7930b25fd8a1a08faa7f1da08c8ca613c6f15e8))
* release 3.4.1 ([#1723](https://github.com/hifihedgehog/3dprintingpeddler/issues/1723)) ([11e6494](https://github.com/hifihedgehog/3dprintingpeddler/commit/11e64942a024472e596a28c44a4e339a7f5197f7))
* release 3.5.0 ([#1745](https://github.com/hifihedgehog/3dprintingpeddler/issues/1745)) ([89e3709](https://github.com/hifihedgehog/3dprintingpeddler/commit/89e3709440d723d070377b69d36fedb84c580bd3))
* remove default label on bug issue ([2115c0c](https://github.com/hifihedgehog/3dprintingpeddler/commit/2115c0c906d4c5963420e775411c5e7aa13edf53))
* remove dependabot ([850f5c8](https://github.com/hifihedgehog/3dprintingpeddler/commit/850f5c8af74efb06a93f4065b83bc71e81fa8306))
* remove hooks ([b6af582](https://github.com/hifihedgehog/3dprintingpeddler/commit/b6af582f70843c5608249c5d629fdec8f10630dd))
* remove old problem matcher ([03539ca](https://github.com/hifihedgehog/3dprintingpeddler/commit/03539ca666036ec06bf77ace04fdd1d27ffbe5cc))
* remove unused dependencies ([53e7a8d](https://github.com/hifihedgehog/3dprintingpeddler/commit/53e7a8d692b76155699b371e926a2b9687d4a081))
* revert puppeteer, run linter ([5e9b3db](https://github.com/hifihedgehog/3dprintingpeddler/commit/5e9b3db6f1630f2000da7f9a8b0dd0dc34c8341f))
* **store:** add 3060 for mediamarkt, saturn and notebooksbilliger ([#2041](https://github.com/hifihedgehog/3dprintingpeddler/issues/2041)) ([cfe292e](https://github.com/hifihedgehog/3dprintingpeddler/commit/cfe292eb3e141da763638ff7cd96a45388a9459f))
* **store:** add 3060 products ([#2029](https://github.com/hifihedgehog/3dprintingpeddler/issues/2029)) ([4d1e1ba](https://github.com/hifihedgehog/3dprintingpeddler/commit/4d1e1ba3e743f744fed3bfb68594d836d1c52794))
* **store:** add a few AMD listings for German stores ([#1321](https://github.com/hifihedgehog/3dprintingpeddler/issues/1321)) ([4f60ad2](https://github.com/hifihedgehog/3dprintingpeddler/commit/4f60ad2a8276e8a568fe6165b5c9dfe4a2177ae2))
* **store:** add additional PS5 bundles and alternative links for MediaMarkt (DE) & Saturn (DE) ([#2820](https://github.com/hifihedgehog/3dprintingpeddler/issues/2820)) ([668ed54](https://github.com/hifihedgehog/3dprintingpeddler/commit/668ed54a9f762e4a7e220b0c9bfadd0b3dcdaf47))
* **store:** add additional PS5 bundles to MediaMarkt (DE) & Saturn (DE) ([#2787](https://github.com/hifihedgehog/3dprintingpeddler/issues/2787)) ([0d936a9](https://github.com/hifihedgehog/3dprintingpeddler/commit/0d936a988586a91e66137083a72e2a3ae9b22f1b))
* **store:** add more links to norwegian stores ([#2485](https://github.com/hifihedgehog/3dprintingpeddler/issues/2485)) ([a286b73](https://github.com/hifihedgehog/3dprintingpeddler/commit/a286b73b5d592868d7140d6de312d5a63a226315))
* **store:** add Nvidia RTX Cards ([#2204](https://github.com/hifihedgehog/3dprintingpeddler/issues/2204)) ([0a9ce0d](https://github.com/hifihedgehog/3dprintingpeddler/commit/0a9ce0dd4c7681cba7681d570db44f65359d83cf))
* **store:** add rx6900xt for microcenter, newegg, bestbuy, amd ([#1284](https://github.com/hifihedgehog/3dprintingpeddler/issues/1284)) ([ba5c504](https://github.com/hifihedgehog/3dprintingpeddler/commit/ba5c50495b531f586d205c689b10c15e6185cbde))
* **store:** add rx6900xt for newegg(-ca), amd-ca, bestbuy, and microcenter ([#1420](https://github.com/hifihedgehog/3dprintingpeddler/issues/1420)) ([316b3bb](https://github.com/hifihedgehog/3dprintingpeddler/commit/316b3bbb813b93b6e68a3d18798442c829313877))
* **store:** add some PS5 bundles ([#2021](https://github.com/hifihedgehog/3dprintingpeddler/issues/2021)) ([d4dc397](https://github.com/hifihedgehog/3dprintingpeddler/commit/d4dc397e9a848d6d2ba1ed56188fb0ddda98e795))
* **store:** add some radeon models for German stores ([#1426](https://github.com/hifihedgehog/3dprintingpeddler/issues/1426)) ([7425e64](https://github.com/hifihedgehog/3dprintingpeddler/commit/7425e6437ff7fa21b43c0d00ab3743cd688528a4))
* **store:** EBGames renamed to Gamestop (in Canada) ([#2734](https://github.com/hifihedgehog/3dprintingpeddler/issues/2734)) ([4e77c67](https://github.com/hifihedgehog/3dprintingpeddler/commit/4e77c67641e85b353c1157e36cbd7c2657dbc01d))
* **store:** rx6800xt for memoryexpress, amazon-ca ([#1491](https://github.com/hifihedgehog/3dprintingpeddler/issues/1491)) ([28d1cf9](https://github.com/hifihedgehog/3dprintingpeddler/commit/28d1cf90b8fe3f92c1ed5850268cb367bbed2463))
* **store:** updated and added Nvidia links ([#2806](https://github.com/hifihedgehog/3dprintingpeddler/issues/2806)) ([c31a861](https://github.com/hifihedgehog/3dprintingpeddler/commit/c31a86121cafd2bda411ea6a3543f0452fb081e5))
* update bug template ([53cb59a](https://github.com/hifihedgehog/3dprintingpeddler/commit/53cb59aada47775b2ab48a1e0e94d2271424a609))
* update dependencies ([f14a1ca](https://github.com/hifihedgehog/3dprintingpeddler/commit/f14a1ca76e41943e639e08a9c8a6299dfa362d9d))
* update dependencies ([1d08d4c](https://github.com/hifihedgehog/3dprintingpeddler/commit/1d08d4c12292e1b98ad952fa4f88c1965fa7bd6a))
* update dependencies ([8d5792b](https://github.com/hifihedgehog/3dprintingpeddler/commit/8d5792bf9e377f10d2c156923162d339ef356fc8))
* update dependencies and nightly workflow ([3b43732](https://github.com/hifihedgehog/3dprintingpeddler/commit/3b43732f291d263792585fa05264dcf322b55620))
* update issue templates ([46bed1e](https://github.com/hifihedgehog/3dprintingpeddler/commit/46bed1ef3c8b838d3b562bc13dfaac18f3b0c045))
* update labels ([64f55c1](https://github.com/hifihedgehog/3dprintingpeddler/commit/64f55c1b8684e3dfc9029d144c7e2cf9cb34d089))
* update logos ([2a5e2e8](https://github.com/hifihedgehog/3dprintingpeddler/commit/2a5e2e873362000ab8c5cdef2c57b6fdb3574ec9))
* update package-lock, remove ci perms ([#3059](https://github.com/hifihedgehog/3dprintingpeddler/issues/3059)) ([ba98f26](https://github.com/hifihedgehog/3dprintingpeddler/commit/ba98f2653ea865cc0c08687b05277566cfc1db32))
* update pr template ([f0e5c5d](https://github.com/hifihedgehog/3dprintingpeddler/commit/f0e5c5d17bad282480da30cc68e5bd8eb9d80844))
* update stale workflow ([e4a267f](https://github.com/hifihedgehog/3dprintingpeddler/commit/e4a267f675800b04d06ddb4212de1373a767a113))
* update template, typos in docs ([#1386](https://github.com/hifihedgehog/3dprintingpeddler/issues/1386)) ([d592cd5](https://github.com/hifihedgehog/3dprintingpeddler/commit/d592cd5d77452363188e69aeaa94e57417f48135))
* **walmart:** update 5900x url ([#2184](https://github.com/hifihedgehog/3dprintingpeddler/issues/2184)) ([b2ce715](https://github.com/hifihedgehog/3dprintingpeddler/commit/b2ce7157d9631d6edd45debcb9ab85bc79241133))
* **xbox:** update oos selector ([4d89306](https://github.com/hifihedgehog/3dprintingpeddler/commit/4d8930616d2296fcdd6c0d79bac2109f1388a0b0)), closes [#2118](https://github.com/hifihedgehog/3dprintingpeddler/issues/2118) [#2479](https://github.com/hifihedgehog/3dprintingpeddler/issues/2479) [#2475](https://github.com/hifihedgehog/3dprintingpeddler/issues/2475) [#2200](https://github.com/hifihedgehog/3dprintingpeddler/issues/2200)
